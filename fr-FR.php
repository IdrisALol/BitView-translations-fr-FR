<?php
/* General stuff */
$LANGS['language'] = 'Français (FR)';
$LANGS['languageenglish'] = 'French (FR)';
$LANGS['languagecode'] = 'fr_FR';
$LANGS['languagechange'] = 'Langue (has been set to) Français (FR).';
...
/* Language window */
$LANGS['welcometobitview'] = 'Bienvenue chez BitView!';
$LANGS['languagesuggestion'] = 'Suggested Language (we have set your preference to this):';
$LANGS['languagesuggestiondesc1'] = 'Pour changez ton langue, utilise la (language selector) sur la fin du page? footer (end of the page).';
...
$LANGS['community'] = 'Communité';
$LANGS['search'] = 'Recherce';
$LANGS['login'] = 'Sign In';
$LANGS['or'] = 'or';
$LANGS['signup'] = 'Creee une Compte';
$LANGS['logout'] = 'Sign Out';
$LANGS['upload'] = 'Upload';
$LANGS['subscriptions'] = 'Subscriptions';
$LANGS['history'] = 'Histoire';
$LANGS['account'] = 'Ma Compte';
...
$LANGS['sendmessage'] = 'envoi/y message';
$LANGS['whatsnew'] = "Nouveau";
$LANGS['readmore'] = 'Read more sur (our) Blog';
...
$LANGS['partnerprogram'] = "Programme (Partner)";

/* Notifications */
$LANGS['searcherror'] = 'Your search query much be at least 2 characters long!';
$LANGS['addvideoplaylist1'] = "You've Ajoute";
$LANGS['addvideoplaylist2'] = 'videos to your playlist!';
$LANGS['addfavorite1'] = "Tu as favori";
$LANGS['addfavorite2'] = 'vidéos!';
$LANGS['groupdoesnotexist'] = "Ce groupe n'existe pas!";
